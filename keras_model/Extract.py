...
rootpath = '/home/rentc/project/bert_chinese_model/chinese_L-12_H-768_A-12'

config_path = os.path.join(rootpath, 'bert_config.json')
checkpoint_path = os.path.join(rootpath, 'keras_model.ckpt')
dict_path = os.path.join(rootpath, 'vocab.txt')
...
train_path = '/home/rentc/project/实体关系/数据/train_data.json'
dev_path = '/home/rentc/project/实体关系/数据/dev_data.json'
...
train_data = processdata(train_path)
dev_data = processdata(dev_path)

id2predicate, predicate2id = {}, {}
# id2predicate = {int(i): j for i, j in id2predicate.items()}

schema_path = '/home/rentc/project/实体关系/数据/all_50_schemas'


def process_schemas(schema_path):
    line = 0
...
id2predicate, predicate2id = process_schemas(schema_path)
...
def repair(d):
    ...
    for sp in d['spo_list']:
        sp = [sp['subject'], sp['predicate'], sp['object']]
